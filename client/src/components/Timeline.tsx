  ...
  return (
    <div className="flex h-full flex-col bg-[#F8F3E8]">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4">
        ...
        <p className="mt-6 border-t border-[#B8962E]/25 pt-4 font-body text-xs text-[#4a3520]/65">
          Event summaries drawn from{" "}
          <Cite
            ids={[
              "lee-1979",
              "wikipedia-morris-canal-2023",
              "debruler-industrial-scenery-2020",
            ]}
          />{" "}
          and the{" "}
          <Link href="/bibliography">
            <span className="text-[#2D5016] underline decoration-[#B8962E]/40">
              full bibliography
            </span>
          </Link>
          .
