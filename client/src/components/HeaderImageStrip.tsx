  ...
  return (
    ...
    >
      <div className="px-2 py-2 sm:px-4 sm:py-3">
        <div className="mb-2 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 px-1 sm:mb-3 sm:justify-between">
          <p className="font-cinzel text-center text-xs tracking-widest text-[#6B5420] uppercase sm:text-left">
            Glimpses along the canal
          </p>
          <Link href="/bibliography">
            <span className="font-cinzel text-[10px] tracking-wide text-[#2D5016] underline decoration-[#B8962E]/50 underline-offset-2 hover:text-[#1A3A0A] sm:text-xs">
