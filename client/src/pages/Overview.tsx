...
import { TrailSignsGallery } from "@/components/TrailSignsGallery";
import { GALLERY_IMAGES, galleryCitationIds } from "@/lib/galleryData";
    ...
    >
      <Section title="Why it mattered">
        ...
        <ArticleFigure
          ...
          citationIds={galleryCitationIds(img("hero"))}
        />
      </Section>
      ...
      <Section title="Opening and everyday life">
        ...
        <ArticleFigure
          ...
          citationIds={galleryCitationIds(img("waterloo"))}
        />
      </Section>
      ...
      <Section title="Closure and memory">
        ...
        <ArticleFigure
          ...
          citationIds={galleryCitationIds(img("map-1827"))}
        />
      </Section>

      <Section title="Along the corridor today">
        <p>
          Centennial field teams photographed surviving prism fragments, locks, and
          interpretive signs along the route. On the interactive map, select a main
          canal town (gold ring) for a then-and-now comparison where field and
          historical images are available.
        </p>
        <TrailSignsGallery className="mt-4" />
      </Section>
      ...
      <Section title="How to use this website">
        <p>
          ...
          . All sources and images are documented in the{" "}
          <Link href="/bibliography">
            <span className="font-semibold text-[#2D5016] underline">Bibliography</span>
          </Link>
          .
        </p>
      </Section>
