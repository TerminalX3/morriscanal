...
type TabId = "landmark" | "timeline" | "stats" | "signs";
...
const TABS: { id: TabId; label: string; icon: React.ReactNode }[] = [
  ...
  { id: "signs", label: "Signs", icon: <Signpost className="h-3.5 w-3.5" /> },
];

const FILTER_OPTIONS = [
  { value: "all", label: "All Sites" },
  { value: "field-site", label: "Field Sites" },
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="font-fell mt-2 max-w-xl text-sm italic leading-relaxed text-white/70">
                  ...
                  <span className="not-italic text-xs text-white/50">
                    {" "}
                    — Fanny Trollope, 1832 <Cite ids={["trollope-1832", "ephemeral-ny-trollope-2019"]} className="text-[#B8962E]/90" />
                  </span>
                </p>
              </div>
      ...
      <div className="flex min-h-0 w-full flex-1 flex-col overflow-hidden md:min-h-[calc(100dvh-12rem)] md:flex-row">
        ...
        >
          ...
          <div className="min-h-0 flex-1 overflow-hidden">
            ...
            {activeTab === "signs" && (
              <div className="h-full overflow-y-auto bg-[#F8F3E8] p-5">
                <TrailSignsGallery />
              </div>
            )}
          </div>
