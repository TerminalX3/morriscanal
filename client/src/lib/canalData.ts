...
export interface Landmark {
  ...
  county?: string;
  image?: string;
  /** CMOS bibliography entry id(s) for landmark image — see bibliographyData.ts */
  imageCitationId?: string | string[];
  /** Present-day field photos (filename location matches landmark.name). */
  presentDayPhotos?: string[];
  /** Interpretive signs at this location. */
  signPhotos?: string[];
}
...
export const LANDMARKS: Landmark[] = [
  ...
  },
  {
    ...
    imageCitationId: ['img-waterloo', 'canalsocietynj-museum-2025'],
  },
  {
    id: 'stanhope',
    name: 'Stanhope',
  ...
  },
  {
    ...
    imageCitationId: ['img-hopatcong-bg', 'wikipedia-morris-canal-2023'],
  },
  {
    id: 'dover',
    name: 'Dover',
  ...
  },
  {
    ...
    lng: -74.245,
    description:
      'Morris County greenway community along the filled canal prism, with Morris Square Park and trail segments commemorating the waterway.',
    historicalNote:
      'The canal corridor through Montville is part of the statewide Morris Canal Greenway, linking preserved fragments for hikers and local history programs.',
    elevation: 280,
    county: 'Morris',
  },
  {
  ...
  },
  {
    ...
    lng: -74.1980,
    description:
      'Field visit site at the Rose Place and Mt. Pleasant Avenue area of Woodland Park (near the Woodland Park Police Department), along the filled Morris Canal prism. Historically, the Little Falls Aqueduct carried the canal over the Passaic River before it was demolished in the 1920s.',
    historicalNote:
      'Fanny Trollope described the aqueduct in 1832: the canal ran above Paterson and crossed the Passaic on a stone structure sixty feet above the river. Centennial photos document the Woodland Park corridor where the waterway once ran.',
    elevation: 80,
    county: 'Passaic',
  },
  {
  ...
  },
  {
    ...
    imageCitationId: ['img-canal-aha', 'njcu-libguides-morriscanal'],
  },
];
